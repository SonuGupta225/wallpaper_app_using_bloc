...
import 'package:wallpaper_app_using_bloc/data_source/remote/app_exception.dart';
import 'package:wallpaper_app_using_bloc/data_source/remote/urls.dart';
    ...
    switch (res.statusCode) {
      ...
      default:
        throw FetchDataException(
            body:
                'Error occurred while Communication with Server with StatusCode : ${res.statusCode}');
    }
  }
}
