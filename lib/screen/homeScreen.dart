...
import 'package:wallpaper_app_using_bloc/constrain/variables.dart';
import 'package:wallpaper_app_using_bloc/models/api_model.dart';
import 'package:wallpaper_app_using_bloc/screen/category_screen.dart';
import 'package:wallpaper_app_using_bloc/screen/search/bloc/search_wall_bloc.dart';
import 'package:wallpaper_app_using_bloc/screen/search/ui/searchscreen.dart';
import 'package:wallpaper_app_using_bloc/screen/wallpaper_view.dart';
                            ...
                            MaterialPageRoute(
                                builder: (context) => BlocProvider(
                                      create: (context) => SearchWallBloc(
                                          apiHelper: ApiHelper()),
                                      child: SearchScreen(
                                        upComingsearch: searchController.text
                                                .toString()
                                                .isNotEmpty
